...
export default function FloatingButton() {
  ...
  return (
    <>  
      <div
        className={`
          fixed bottom-30 left-4 z-50 w-[360px] max-h-[560px] flex flex-col
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-[#0d1117] border-b border-blue-500/20">
          ...
          <button
            ...
            className="w-7 h-7 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors text-gray-400 hover:text-white"
          >
            ✕
          </button>
        </div>
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              {SUGGESTED_QUESTIONS.map((q) => (
                <button
                  ...
                  className="text-xs px-3 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-300 hover:bg-blue-500/20 hover:border-blue-400 transition-all duration-150"
                >
                  {q}
                </button>
              ))}
        ...
        <div className="px-3 py-3 border-t border-blue-500/10 bg-[#0d1117]">
          <div className="flex items-center gap-2 bg-[#161b22] border border-blue-500/20 rounded-xl px-3 py-2">
            ...
            <button
              ...
              className="w-7 h-7 rounded-lg bg-blue-600 hover:bg-blue-500 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-colors"
            >
